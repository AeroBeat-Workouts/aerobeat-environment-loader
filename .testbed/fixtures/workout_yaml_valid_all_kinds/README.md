...
- the gaussian-splat environment now targets the committed `.compressed.ply` placeholder while reusing the sibling `.json` sidecar config expected by the current loader contract
